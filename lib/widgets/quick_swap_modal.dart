...
class _QuickSwapModalState extends State<QuickSwapModal> {
  ...
  final Map<String, List<WorkoutExercise>> exercisesByBodyPart = {
    'Chest': [
      ...
      const WorkoutExercise(id: 'cable_flyes', name: 'Cable Flyes', sets: 3, reps: 12),
      const WorkoutExercise(id: 'dips', name: 'Chest Dips', sets: 3, reps: 12),
      const WorkoutExercise(id: 'pushups', name: 'Push-ups', sets: 3, reps: 15),
      const WorkoutExercise(id: 'wide_pushups', name: 'Wide Push-ups', sets: 3, reps: 15),
      const WorkoutExercise(id: 'diamond_pushups', name: 'Diamond Push-ups', sets: 3, reps: 12),
    ...
    'Back': [
      ...
      const WorkoutExercise(id: 'pull_ups', name: 'Pull-ups', sets: 3, reps: 10),
      const WorkoutExercise(id: 'chin_ups', name: 'Chin-ups', sets: 3, reps: 10),
      const WorkoutExercise(id: 'bent_over_rows', name: 'Bent Over Rows', sets: 3, reps: 10),
      const WorkoutExercise(id: 'lat_pulldowns', name: 'Lat Pulldowns', sets: 3, reps: 12),
      const WorkoutExercise(id: 'cable_rows', name: 'Cable Rows', sets: 3, reps: 12),
      ...
      const WorkoutExercise(id: 'face_pulls', name: 'Face Pulls', sets: 3, reps: 15),
      const WorkoutExercise(id: 'reverse_flys', name: 'Reverse Flyes', sets: 3, reps: 12),
    ],
    'Shoulders': [
      ...
      const WorkoutExercise(id: 'lateral_raises', name: 'Lateral Raises', sets: 3, reps: 15),
      const WorkoutExercise(id: 'front_raises', name: 'Front Raises', sets: 3, reps: 15),
      const WorkoutExercise(id: 'rear_delt_flys', name: 'Rear Delt Flyes', sets: 3, reps: 15),
      const WorkoutExercise(id: 'cable_lateral_raises', name: 'Cable Lateral Raises', sets: 3, reps: 15),
      const WorkoutExercise(id: 'pike_pushups', name: 'Pike Push-ups', sets: 3, reps: 12),
      const WorkoutExercise(id: 'upright_rows', name: 'Upright Rows', sets: 3, reps: 12),
      const WorkoutExercise(id: 'shrugs', name: 'Shrugs', sets: 3, reps: 15),
    ],
    'Arms': [
      const WorkoutExercise(id: 'bicep_curls', name: 'Bicep Curls', sets: 3, reps: 12),
      const WorkoutExercise(id: 'hammer_curls', name: 'Hammer Curls', sets: 3, reps: 12),
      const WorkoutExercise(id: 'preacher_curls', name: 'Preacher Curls', sets: 3, reps: 12),
      const WorkoutExercise(id: 'cable_curls', name: 'Cable Curls', sets: 3, reps: 15),
      const WorkoutExercise(id: 'tricep_dips', name: 'Tricep Dips', sets: 3, reps: 12),
      const WorkoutExercise(id: 'tricep_pushdowns', name: 'Tricep Pushdowns', sets: 3, reps: 15),
      const WorkoutExercise(id: 'overhead_tricep_extension', name: 'Overhead Tricep Extension', sets: 3, reps: 12),
      const WorkoutExercise(id: 'skull_crushers', name: 'Skull Crushers', sets: 3, reps: 12),
      const WorkoutExercise(id: 'close_grip_bench', name: 'Close Grip Bench Press', sets: 3, reps: 10),
      const WorkoutExercise(id: 'concentration_curls', name: 'Concentration Curls', sets: 3, reps: 12),
    ],
    'Legs': [
      const WorkoutExercise(id: 'squats', name: 'Squats', sets: 3, reps: 10),
      ...
      const WorkoutExercise(id: 'lunges', name: 'Lunges', sets: 3, reps: 12),
      const WorkoutExercise(id: 'bulgarian_split_squats', name: 'Bulgarian Split Squats', sets: 3, reps: 10),
      const WorkoutExercise(id: 'leg_extensions', name: 'Leg Extensions', sets: 3, reps: 15),
      const WorkoutExercise(id: 'leg_curls', name: 'Leg Curls', sets: 3, reps: 15),
      const WorkoutExercise(id: 'romanian_deadlift', name: 'Romanian Deadlift', sets: 3, reps: 10),
      const WorkoutExercise(id: 'calf_raises', name: 'Calf Raises', sets: 3, reps: 20),
      const WorkoutExercise(id: 'glute_bridge', name: 'Glute Bridge', sets: 3, reps: 15),
    ],
    'Core': [
      const WorkoutExercise(id: 'planks', name: 'Planks', sets: 3, reps: 60, timeSeconds: 60),
      const WorkoutExercise(id: 'crunches', name: 'Crunches', sets: 3, reps: 20),
      const WorkoutExercise(id: 'russian_twists', name: 'Russian Twists', sets: 3, reps: 30),
      const WorkoutExercise(id: 'leg_raises', name: 'Leg Raises', sets: 3, reps: 15),
    ...
    'Cardio': [
      const WorkoutExercise(id: 'burpees', name: 'Burpees', sets: 3, reps: 15),
      const WorkoutExercise(id: 'jumping_jacks', name: 'Jumping Jacks', sets: 3, reps: 30),
      const WorkoutExercise(id: 'high_knees', name: 'High Knees', sets: 3, reps: 30),
      const WorkoutExercise(id: 'box_jumps', name: 'Box Jumps', sets: 3, reps: 15),
