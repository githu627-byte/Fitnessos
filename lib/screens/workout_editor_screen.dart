              ...
              children: [
                ...
                Expanded(
                  child: GestureDetector(
                    onTap: () {
                      HapticFeedback.selectionClick();
                      // Find matching exercise from WorkoutData
                      final matchedExercise = WorkoutData.getAllExercises().firstWhere(
                        (e) => e.id == exercise.id,
                        orElse: () => Exercise(
                          id: exercise.id,
                          name: exercise.name,
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ExerciseExplanationScreen(exercise: matchedExercise),
                        ),
                      );
                    },
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        decorationColor: exercise.included
                            ? Colors.white.withOpacity(0.3)
                            : AppColors.white40.withOpacity(0.3),
                      ),
                    ),
                  ),
                ),
