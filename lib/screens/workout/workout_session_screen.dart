...
// import 'camera_workout_screen.dart'; // Removed - screen doesn't exist
          ...
          if (isCurrentExercise && !allSetsComplete) ...[
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  // TODO: Navigate to camera workout screen or use Train tab
                  // Camera workout screen has been removed/consolidated
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('Use Train tab for camera-based workouts'),
                    ),
                  );
                  /*
