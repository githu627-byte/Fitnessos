...
class _CameraTabState extends ConsumerState<CameraTab> {
  ...
  Future<void> _processFrame(CameraImage image) async {
    try {
      ...
      // Store landmarks for display
      setState(() {
        _poses = []; // Keep empty for now since _poses expects Pose objects
      });
      
      // 2. Count reps (commented out - needs refactoring for new landmark format)
      // TODO: Update rep counting to work with List<PoseLandmark>
      /*
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // Pose overlay - disabled for now
          // TODO: Update to use SkeletonPainter with landmarks
          /*
