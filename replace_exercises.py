...
# Read the current workout_data.dart file
with open('lib/models/workout_data.dart', 'r') as f:
    lines = f.readlines()

# Find the start and end of the allMovementEngineExercises list
start_line = None
end_line = None

for i, line in enumerate(lines):
    if 'static const List<Exercise> allMovementEngineExercises = [' in line:
        start_line = i + 1  # Start after the opening bracket line
        break
...
print(f"Found list from line {start_line} to {end_line}")

# The new exercise list (696 exercises)
new_exercises = """    Exercise(id: '3_4_sit_up', name: '3/4 Sit-Up', difficulty: 'intermediate', equipment: 'bodyweight'),
...
new_lines = lines[:start_line] + [new_exercises + '\n'] + lines[end_line:]

# Write the updated file
with open('lib/models/workout_data.dart', 'w') as f:
    f.writelines(new_lines)

print("Successfully replaced the exercise list!")
print(f"New list has {len(new_exercises.split('Exercise('))-1} exercises")